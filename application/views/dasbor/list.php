                            ...
                            <table class ="table table-bordered" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($item->jumlah_transaksi) ?></td>
                                        <td><?php echo $item->total_item ?></td>
                                        <td><?php echo $item->status_bayar ?></td>
                                        <td><a href="<?php echo base_url('dasbor/detail/'.$item->kode_transaksi)?>"class="btn btn-success btn-xs"><i class="fa fa-eye"></i>Detail</a></td>
                                    </tr>    
                                    <?php $i++; }?>                            
                                </tbody>
                            </table>
